...
{
    [AddinAttribute(Caption = "IoT", BranchType = EnumPointType.Entity, Name = "IoTEntitiesNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class IoTEntitiesNode : IBranch 
    {
        public IoTEntitiesNode() { }

        public IoTEntitiesNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, IDataSource ds)
        {
            DataSource = ds;
