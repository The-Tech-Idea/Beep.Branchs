...
{
    [AddinAttribute(Caption = "IoT", BranchType = EnumPointType.Category, Name = "IoTCategoryNode.Beep", misc = "Beep", iconimage = "category.png", menu = "Beep", ObjectType = "Beep")]
    public class IoTCategoryNode : IBranch 
    {
        public IoTCategoryNode() { }

        public IoTCategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
        ...
        public IErrorsInfo CreateChildNodes()
        {
            try
            {
                ...
                foreach (CategoryFolder p in DMEEditor.ConfigEditor.CategoryFolders.Where(x => x.RootName.Equals("IoT", StringComparison.InvariantCultureIgnoreCase) && x.FolderName == BranchText))
                {
