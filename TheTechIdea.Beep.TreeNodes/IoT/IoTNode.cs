...
{
    [AddinAttribute(Caption = "IoT", BranchType = EnumPointType.DataPoint, Name = "IoTNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class IoTNode : IBranch 
    {
        public IoTNode() { }

        public IoTNode(ConnectionProperties i, ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
