...
{
    [AddinAttribute(Caption = "MLModel", BranchType = EnumPointType.Entity, Name = "MLModelEntitiesNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class MLModelEntitiesNode : IBranch 
    {
        public MLModelEntitiesNode() { }

        public MLModelEntitiesNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, IDataSource ds)
        {
            DataSource = ds;
