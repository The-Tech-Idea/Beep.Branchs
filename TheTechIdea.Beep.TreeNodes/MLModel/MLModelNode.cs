...
{
    [AddinAttribute(Caption = "MLModel", BranchType = EnumPointType.DataPoint, Name = "MLModelNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class MLModelNode : IBranch 
    {
        public MLModelNode() { }

        public MLModelNode(ConnectionProperties i, ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
