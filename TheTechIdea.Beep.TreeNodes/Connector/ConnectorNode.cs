...
{
    [AddinAttribute(Caption = "Connector", BranchType = EnumPointType.DataPoint, Name = "ConnectorNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class ConnectorNode : IBranch 
    {
        public ConnectorNode() { }

        public ConnectorNode(ConnectionProperties i, ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
