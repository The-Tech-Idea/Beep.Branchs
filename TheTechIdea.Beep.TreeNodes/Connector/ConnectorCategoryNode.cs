...
{
    [AddinAttribute(Caption = "Connector", BranchType = EnumPointType.Category, Name = "ConnectorCategoryNode.Beep", misc = "Beep", iconimage = "category.png", menu = "Beep", ObjectType = "Beep")]
    public class ConnectorCategoryNode : IBranch 
    {
        public ConnectorCategoryNode() { }

        public ConnectorCategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
        ...
        public string BranchClass { get; set; } = "Connector";
        ...
        public IErrorsInfo CreateChildNodes()
        {
            try
            {
                ...
                foreach (CategoryFolder p in DMEEditor.ConfigEditor.CategoryFolders.Where(x => x.RootName.Equals("Connector", StringComparison.InvariantCultureIgnoreCase) && x.FolderName == BranchText))
                {
        ...
        public IErrorsInfo CreateDBNode(ConnectionProperties i)
        {
            try
            {
                ...
                ConnectorNode database = new ConnectorNode(i, TreeEditor, DMEEditor, this, i.ConnectionName, TreeEditor.SeqID, EnumPointType.DataPoint, icon);
