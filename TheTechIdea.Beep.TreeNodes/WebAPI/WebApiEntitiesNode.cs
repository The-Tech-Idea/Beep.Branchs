...
{
    [AddinAttribute(Caption = "WebApi", BranchType = EnumPointType.Entity, Name = "WebApiEntitiesNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class WebApiEntitiesNode : IBranch 
    {
        public WebApiEntitiesNode() { }

        public WebApiEntitiesNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, IDataSource ds)
        {
            DataSource = ds;
