...
namespace TheTechIdea.Beep.TreeNodes.RDBMS
{
    ...
    public class DatabaseNode  : IBranch 
    {
        ...
        //    try
        //    {
        //        if (Visutil.Controlmanager.InputBoxYesNo("Beep DM", "Are you sure you ?") ==Beep.Vis.Module.DialogResult.Yes)
        //        {
        ...
        //            {
        //                if (Visutil.Controlmanager.InputBoxYesNo("Beep DM", "Are you sure, this might take some time?") == Beep.Vis.Module.DialogResult.Yes)
        //                {
