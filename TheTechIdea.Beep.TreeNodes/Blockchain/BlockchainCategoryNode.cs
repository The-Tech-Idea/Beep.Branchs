...
{
    [AddinAttribute(Caption = "Blockchain", BranchType = EnumPointType.Category, Name = "BlockchainCategoryNode.Beep", misc = "Beep", iconimage = "category.png", menu = "Beep", ObjectType = "Beep")]
    public class BlockchainCategoryNode : IBranch 
    {
        public BlockchainCategoryNode() { }

        public BlockchainCategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
        ...
        public string BranchClass { get; set; } = "Blockchain";
        ...
        public IErrorsInfo CreateChildNodes()
        {
            try
            {
                ...
                foreach (CategoryFolder p in DMEEditor.ConfigEditor.CategoryFolders.Where(x => x.RootName.Equals("Blockchain", StringComparison.InvariantCultureIgnoreCase) && x.FolderName == BranchText))
                {
        ...
        public IErrorsInfo CreateDBNode(ConnectionProperties i)
        {
            try
            {
                ...
                BlockchainNode database = new BlockchainNode(i, TreeEditor, DMEEditor, this, i.ConnectionName, TreeEditor.SeqID, EnumPointType.DataPoint, icon);
