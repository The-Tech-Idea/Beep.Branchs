...
{
    [AddinAttribute(Caption = "Blockchain", BranchType = EnumPointType.DataPoint, Name = "BlockchainNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class BlockchainNode : IBranch 
    {
        public BlockchainNode() { }

        public BlockchainNode(ConnectionProperties i, ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
