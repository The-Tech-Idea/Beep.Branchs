...
{
    [AddinAttribute(Caption = "NoSql", BranchType = EnumPointType.Entity, Name = "NoSqlEntitiesNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class NoSqlEntitiesNode : IBranch 
    {
        public NoSqlEntitiesNode() { }

        public NoSqlEntitiesNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, IDataSource ds)
        {
            DataSource = ds;
