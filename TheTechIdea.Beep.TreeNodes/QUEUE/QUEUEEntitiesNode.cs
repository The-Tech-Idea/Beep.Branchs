...
{
    [AddinAttribute(Caption = "QUEUE", BranchType = EnumPointType.Entity, Name = "QUEUEEntitiesNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class QUEUEEntitiesNode : IBranch 
    {
        public QUEUEEntitiesNode() { }

        public QUEUEEntitiesNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, IDataSource ds)
        {
            DataSource = ds;
