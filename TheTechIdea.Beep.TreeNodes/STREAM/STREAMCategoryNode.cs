...
{
    [AddinAttribute(Caption = "STREAM", BranchType = EnumPointType.Category, Name = "STREAMCategoryNode.Beep", misc = "Beep", iconimage = "category.png", menu = "Beep", ObjectType = "Beep")]
    public class STREAMCategoryNode : IBranch 
    {
        public STREAMCategoryNode() { }

        public STREAMCategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
        ...
        public string BranchClass { get; set; } = "STREAM";
        ...
        public IErrorsInfo CreateChildNodes()
        {
            try
            {
                ...
                foreach (CategoryFolder p in DMEEditor.ConfigEditor.CategoryFolders.Where(x => x.RootName.Equals("STREAM", StringComparison.InvariantCultureIgnoreCase) && x.FolderName == BranchText))
                {
        ...
        public IErrorsInfo CreateDBNode(ConnectionProperties i)
        {
            try
            {
                ...
                STREAMNode database = new STREAMNode(i, TreeEditor, DMEEditor, this, i.ConnectionName, TreeEditor.SeqID, EnumPointType.DataPoint, icon);
