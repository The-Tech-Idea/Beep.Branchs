...
{
    [AddinAttribute(Caption = "STREAM", BranchType = EnumPointType.DataPoint, Name = "STREAMNode.Beep", misc = "Beep", iconimage = "database.png", menu = "Beep", ObjectType = "Beep")]
    public class STREAMNode : IBranch 
    {
        public STREAMNode() { }

        public STREAMNode(ConnectionProperties i, ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
